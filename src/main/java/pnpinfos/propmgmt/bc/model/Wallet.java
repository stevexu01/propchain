package pnpinfos.propmgmt.bc.model;

import pnpinfos.propmgmt.bc.main.NoobChain;
...
public class Wallet {
    ...
    public void generateKeyPair() {
        try {
            ...
            keyGen.initialize(rsaSpec, random);   //256 bytes provides an acceptable security level
